...
{
    throw new Error("shri ji google client id is not defined in .env by shri ji")
}
if(!process.env.GOOGLE_CLIENT_SECRET)
{
    throw new Error("shri ji google client secret is not defined in .env by shri ji")
}
if(!process.env.IMAGEKIT_PRIVATE_KEY)
{
    throw new Error("shri ji imagekit private key is not defined in .env by shri ji")
}
